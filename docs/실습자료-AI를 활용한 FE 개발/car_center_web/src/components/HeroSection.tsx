...
import carImage from "figma:asset/c401729e258ab34293ba7f167903161bb40e1c09.png";
...
export function HeroSection({ onStatusClick, onBookingClick }: HeroSectionProps) {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 text-primary rounded-full">
                ...
                <span className="text-sm font-medium">신뢰할 수 있는 정비 서비스</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                투명한 가격, 실시간 정비 현황 확인, 전문 정비사의 꼼꼼한 점검으로<br />
